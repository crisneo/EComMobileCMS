		...
		<div data-role="navbar">
			<ul>
				...
				<li><a href="<c:url value="/contact"  />"
					class="ui-btn-active ui-state-persist" rel="external">Contacto</a></li>
			...
			<form action="" method="post">
				...
				<div data-role="fieldcontain">
					<label for="username">nombre:</label> <input type="text"
						name="name" required id="name" value="" placeholder="your name" />
				</div>
				<div data-role="fieldcontain">
					<label for="email" class="">email:</label> <input type="email"
						required id="email" placeholder="your@email.com" />
				</div>
				<div data-role="fieldcontain">
					<label for="textarea">mensaje:</label>
					<textarea cols="40" rows="15" name="textarea" id="textarea"></textarea>
				</div>
				<div data-role="fieldcontain">
					<input type="submit" value="enviar" id="btnForm">
				</div>
