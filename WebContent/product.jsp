...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <a href="http://www.free-css.com/">Productos: </a> &lt; <span class="current">${product.name}</span> </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">${product.code} - ${product.name}</div>
      <div class="prod_box_big">
        <div class="top_prod_box_big"></div>
        <div class="center_prod_box_big">
          <div class="product_img_big"> 
          <c:url value="/imageProcuct/${product.code}" var="cc2" />
			
          <a href="javascript:popImage('${cc2}','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]">
          <img src="${cc2}" alt="" border="0" style="width:200px; height:250px;" /></a>
            <div class="thumbs"> 
            <a href="http://www.free-css.com/" title="header=[Thumb1] body=[&nbsp;] fade=[on]">
            <img src="" alt="" border="0" /></a>
             <a href="http://www.free-css.com/" title="header=[Thumb2] body=[&nbsp;] fade=[on]">
             <img src="" alt="" border="0" /></a> 
             <a href="http://www.free-css.com/" title="header=[Thumb3] body=[&nbsp;] fade=[on]">
             <img src="" alt="" border="0" /></a> </div>
          </div>
          <div class="details_big_box">
            <div class="product_title_big">${product.description}</div>
            <div class="specifications"> 
            	<!-- Disponibilidad: <span class="blue">In stoc</span><br />-->
              Codigo: <span class="blue">${product.code}</span><br />
              Nombre: <span class="blue">${product.name}</span><br />
              Unidades: <span class="blue">${product.availableUnits}</span><br />
            </div>
            <div class="prod_price_big">
            <!-- <span class="reduce">${product.price}</span> -->
            <span class="price">${product.price}</span></div>
            <c:url value="/loggedUser/addToCart/${product.code}" var="addplink" />
            <a href="${addplink}" class="addtocart">Agregar al carrito</a> 
            <!-- <a href="http://www.free-css.com/" class="compare">compare</a> </div>-->
        </div>
      ...
      <c:url value="/imageProcuct/${offProd.code}" var="offImage" />
        ...
        <c:url value="/loggedUser/addToCart/${prod.code}" var="offCart" />
