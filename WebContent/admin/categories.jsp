...
<!-- csrt for log out-->
    ...
    <div id="midcontent">
      ...
      <h1 class="posthead">Categorías</h1>
 ...
 <th></th>
			...
			<c:forEach var="listValue" items="${categories}">
				...
				<td>${listValue.imageUrl}</td>-->
				
				<td><c:url value="/admin/editCategoryForm/${listValue.id}" var="link" />
					<a href="${link}">Modificar</a></td>
				<td><c:url value="/admin/deleteCategory/${listValue.id}" var="dlink" />
	...
	<c:url value="/admin/newCategoryForm" var="newLink" />
<a href="${newLink}" class="button">Nueva Categoría</a> 
