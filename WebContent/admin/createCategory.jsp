...
<!-- csrt for log out-->
    ...
    <div id="midcontent">
      ...
      <h1 class="posthead">Nueva categoría</h1>
      <form:form method="post" action="addCategory" enctype="multipart/form-data" class="foorm">
    ...
    <!-- <tr>
        ...
        <td><input type="file" name="imageUrl" id="image"></td>
    </tr>-->
    <tr>
    <td colspan="2">
