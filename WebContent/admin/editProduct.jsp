...
<!-- csrt for log out-->
    ...
    <div id="midcontent">
      ...
      <h1 class="posthead">Modificar producto</h1>
      <form:form method="post" action="${pageContext.request.contextPath}/admin/updateProduct" enctype="multipart/form-data" class="foorm">
    ...
    <tr>
    <td><label>Imagen actual:</label>
    </td>
    <td>
     <c:url value="/imageProcuct/${command.code}" var="cc2" />
				<img src="${cc2}" style="width:100px; height:100px;" />
    </td>
    </tr>
    <tr>
