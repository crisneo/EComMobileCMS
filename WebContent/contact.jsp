...
<div id="main_container">
  ...
  <div id="header">
    <div id="logo"> <img src="<c:url value="/resources/endUser/images/logo.png" />" alt="" border="0" width="237" height="140" /></div>
  ...
  <div id="main_content">
    ...
    <!-- end of menu tab -->
    <div class="crumb_navigation"> Navegacion: <span class="current">Contacto</span> </div>
...
<tr>
 <td valign="top">
  <label for="comments">Texto *</label>
 </td>
 <td valign="top">
